 ...
 */
+ (void)trackLoginEvent:(NSString *)userId params:(nullable NSDictionary<NSString *, NSString *> *)eventParams;
...
/**
 ...
 @param eventParams Any optional parameters can be passed with event as «key-value» by optional parameter eventParams. Max key or value length — 255 chars.
*/
+ (void)trackRegistrationEvent:(NSString *)userId params:(nullable NSDictionary<NSString *, NSString *> *)eventParams;
